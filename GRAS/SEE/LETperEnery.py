...
#plt.show()
plt.savefig("/home/anton/Desktop/triton_work/Chess1 GNSS SEE Analysis/Stopping Powers and Ranges/Geant4 Stopping Power and Ranges.pdf", format='pdf', bbox_inches="tight")