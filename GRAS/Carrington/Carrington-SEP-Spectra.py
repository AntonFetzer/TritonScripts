...
# plt.plot(ISS_SEP_Data[0, :, 0], ISS_SEP_Data[0, :, 1], '.--', label="SAPPHIRE ISS SEP Proton Flux", color=ISSColor)

# ## Read in Geostationary SEP spectrum
# GEO_SEP = "/l/triton_work/Spectra/GEO/spenvis_sef.txt"
# GEO_SEP_Data = readSpenvis_sef(GEO_SEP)
# plt.plot(GEO_SEP_Data[0, :, 0], GEO_SEP_Data[0, :, 1], '.--', label="SAPPHIRE GEO SEP Proton Flux", color=GEOColor)
...
# plt.plot(VAB_SEP_Data[0, :, 0], VAB_SEP_Data[0, :, 1], '.--', label="SAPPHIRE Van-Allen-Belt SEP Proton Flux", color=VABColor)
...
plt.plot(GEO_Flare_Data['Energy'], GEO_Flare_Data['IFlux'], '.-', label="CREME96 GEO Peak 5min Flux", color=GEOColor, linewidth=5)
...
plt.savefig("/l/triton_work/Spectra/Carrington/ProtonSpectrumComparison.pdf", format='pdf', bbox_inches="tight")
# plt.show()